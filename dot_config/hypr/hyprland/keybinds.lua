...
-- 禁用Menu键
hl.bind("Menu", hl.dsp.exec_cmd("true"))
hl.bind("ALT + Menu", hl.dsp.exec_cmd("true"))
hl.bind("ALT + SHIFT + Menu", hl.dsp.exec_cmd("true"))
hl.bind("CTRL + Menu", hl.dsp.exec_cmd("true"))
hl.bind("CTRL + SHIFT + Menu", hl.dsp.exec_cmd("true"))
hl.bind("CTRL + ALT + Menu", hl.dsp.exec_cmd("true"))
hl.bind("CTRL + ALT + SHIFT + Menu", hl.dsp.exec_cmd("true"))
hl.bind("SHIFT + Menu", hl.dsp.exec_cmd("true"))
