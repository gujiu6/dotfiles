...
-- 这种格式是 Neovide 解析字号最稳定的方式
vim.o.guifont = is_windows and "JetBrainsMono Nerd Font:h22" or "JetBrainsMono Nerd Font:h14"
-- vim.g.neovide_cursor_trail_size = 0.85 -- 光标轨迹长度
vim.g.clneovide_cursor_animation_length = 0.065 -- 光标拖尾 [单位秒]
vim.g.neovide_opacity = 0.7 -- 窗口透明度
